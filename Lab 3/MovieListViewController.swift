...
class MovieListViewController: UITableViewController {
    ...
    private static let movieListViewReuseIdentifier = "weeeeeee"
...
//		tableView.register(UITableViewCell.self, forCellReuseIdentifier: "cell")
        tableView.register(UITableViewCell.self, forCellReuseIdentifier: MovieListViewController.movieListViewReuseIdentifier)
	...
	override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		let cell = tableView.dequeueReusableCell(withIdentifier: MovieListViewController.movieListViewReuseIdentifier, for: indexPath)
...
//		searchMoviesListViewController.queryString = queryStrings[1]
        ...
        print(searchMoviesListViewController)
        
        self.navigationController?.pushViewController(searchMoviesListViewController, animated: true)
        print("wew!")
